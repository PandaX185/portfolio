...
const IntroductionBlock = () => {
  return (
    <div className="flex flex-col px-4 w-full h-screen items-center justify-center bg-gray-950">
      <div className="flex w-full h-full items-center justify-around ">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              <em className="text-pink-600">frontend</em> using React and
              NextJS.
            </p>
          </div>
        </div>
        <div>
          <Image
            className="rounded-full lg:w-[20rem] lg:h-[20rem] lg:min-w-[19rem] md:min-w-[15rem] min-w-[10rem] md:w-[17rem] md:h-[16rem] w-[13rem] h-[11rem] border-2 border-pink-400 animate-pulse hover:animate-none hover:border-4 duration-200 hover:border-pink-20  0"
            src="/pfp.jpg"
